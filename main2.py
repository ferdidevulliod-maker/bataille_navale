...
def charger_score():
    ...
    """Charge les scores depuis le fichier CSV enregistrer au prealable."""
...
def sauvegarder_score():
    """Sauvegarde les scores actuels dans le CSV soit celui qui vient d'etre creer ou le precedent."""
